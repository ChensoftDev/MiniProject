...
public class upcomingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(view == null) {
            ...
            recyclerView = (RecyclerView)  view.findViewById(R.id.rcvUpcoming);
                        ...
                        for (DataSnapshot snap : dataSnapshot.getChildren()) {
                            try {
                                ...
                                if(Integer.parseInt(startdate.replaceAll("[\\D]", "")) > todaydate && Integer.parseInt(enddate.replaceAll("[\\D]", "")) > todaydate)  {
                                    listTournament.add(new listTournamentCls(tournamentname,category,difficulty,startdate,enddate,like,"Upcoming"));
                                }
